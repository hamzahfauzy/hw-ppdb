...
<head>
  ...
  <title>PPDB BAITUN NAIM - NIK Sudah Terdaftar</title>
    ...
    <div id="msform">
        <div class="col-md-12">
            ...
            <fieldset class="active">
              <center>
                <h2 class="fs-title">NIK atau Email Sudah Terdaftar</h2>
                <h3 class="fs-subtitle">NIK dengan nomor <b><?=$_SESSION['daftar']['data_pribadi']['NIK']?></b> atau email <b><?=$_SESSION['daftar']['data_pribadi']['email']?></b> Sudah terdaftar pada sistem.</h3>
