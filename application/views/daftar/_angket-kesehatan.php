<center>
  <h2 class="fs-title">Angket Kesehatan</h2>
...
<div class="row equal">
  ...
  <div class="col-sm-12 col-md-6">
    <div class="form-group">
      ...
      <textarea name="kesehatan[eye_problem_description]" placeholder="Deskripsi Gangguan Mata" class="form-control" <?=isset($_SESSION['daftar']['eye_problem_status'])&&$_SESSION['daftar']['eye_problem_status']=='YA'?'':'style="display: none"'?>><?=@$_SESSION['daftar']['kesehatan']['eye_problem_description']?></textarea>
    </div>
  </div>
  <div class="col-sm-12 col-md-6">
    <div class="form-group">
