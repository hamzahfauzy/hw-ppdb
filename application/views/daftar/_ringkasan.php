...
<?php if(isset($_SESSION['daftar']['asal_sekolah']['name']) && !empty($_SESSION['daftar']['asal_sekolah']['name'])): ?>
<h2 class="fs-title">Asal Sekolah</h2>
<div class="table-responsive">
<table class="table table-bordered">
  <tr>
      <label>Nama <?=$_SESSION['daftar']['data_jenjang'] == 'TK'?'PAUD/PLAY GROUP':'TK/RA'?></label>
...
<div class="loading-overlay" style="display:none;">
  <div class="loader">
      <span>Sedang mengupload data. Harap menunggu...</span>
  </div>
</div>