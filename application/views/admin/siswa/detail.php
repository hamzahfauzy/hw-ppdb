    ...
    <section class="content container-fluid">
      <div class="box box-primary">
        <div class="box-header">
          ...
          ?>
          <a href="<?=base_url('admin/siswa/edit/'.$siswa->id)?>" class="btn btn-success">Edit</a>
          ...
          <a href="<?=base_url('admin/siswa/lulus/'.$siswa->id)?>" class="btn btn-primary" onclick="if(confirm('Apakah anda yakin mengkonfirmasi kelulusan calon siswa ini?')){return true}else{return false}">Konfirmasi Kelulusan</a>
          <br>
          <?php endif ?>
          ...
          <?php if($siswa->status == 'Daftar Ulang'): ?>
          <a href="<?=base_url('admin/siswa/print/'.$siswa->id)?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Cetak Surat Tanda Terima</a>
          <?php endif ?>
        </div>
        <div class="box-body">
          <center>
